                    ...
                    <ul className="space-y-4">
                        {results.map((result, index) => (
                            <li key={index} className="flex items-center gap-4 p-4 border rounded-lg transition-all hover:bg-secondary/50">
                                ...
                                <Badge className={`text-base ${result.compatibilityScore > 75 ? "bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-200" : result.compatibilityScore > 50 ? "bg-yellow-100 text-yellow-800 dark:bg-yellow-900 dark:text-yellow-200" : "bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-200"}`}>
